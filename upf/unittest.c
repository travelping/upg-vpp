...
setup_apps (u32 *app_id, u32 *app_id_any)
{
  ...
  UPF_TEST (test_add_ip_rule (app_name, 2000,
              ...
              0,
            "add ip rule 2000");
  UPF_TEST (test_add_ip_rule (
              app_name, 2001,
              "permit out ip from 192.168.0.0/24 70-100 to assigned") == 0,
            "add ip rule 2001");
  UPF_TEST (
    test_add_ip_rule (app_name, 2002,
  ...
  *app_id = upf_adf_get_adr_db (p[0]);
  /* UPF_TEST (fib_table_find (FIB_PROTOCOL_IP4, 10000000 + (*app -
   * gtm->upf_apps)) != ~0, */
  /*           "FIB table created (IP4)"); */
  /* UPF_TEST (fib_table_find (FIB_PROTOCOL_IP6, 20000000 + (*app -
   * gtm->upf_apps)) != ~0, */
  ...
  *app_id_any = upf_adf_get_adr_db (p[0]);
  /* UPF_TEST (fib_table_find (FIB_PROTOCOL_IP4, 10000000 + (*app_any -
   * gtm->upf_apps)) != ~0, */
  /*           "FIB table created (IP4)"); */
  /* UPF_TEST (fib_table_find (FIB_PROTOCOL_IP6, 20000000 + (*app_any -
   * gtm->upf_apps)) != ~0, */
  /*           "FIB table created (IP6)"); */
...
ip_app_test_v6 (void)
{
  ...
  ip46_address_t ip_ue_2001_db8_11__3 = { .ip6.as_u64 = {
                                            clib_host_to_net_u64 (
                                              0x20010db800110000),
                                            clib_host_to_net_u64 (
                                              0x0000000000000003),
                                          } };
  ip46_address_t ip_2001_db8_13__5 = { .ip6.as_u64 = {
                                         clib_host_to_net_u64 (
                                           0x20010db800130000),
                                         clib_host_to_net_u64 (
                                           0x0000000000000005),
                                       } };
  ip46_address_t ip_2001_db8_12__2 = { .ip6.as_u64 = {
                                         clib_host_to_net_u64 (
                                           0x20010db800120000),
                                         clib_host_to_net_u64 (
                                           0x0000000000000002),
                                       } };
  ip46_address_t ip_2001_db8_12__3 = { .ip6.as_u64 = {
                                         clib_host_to_net_u64 (
                                           0x20010db800120000),
                                         clib_host_to_net_u64 (
                                           0x0000000000000003),
  ...
  UPF_TEST (
    !upf_app_ip_rule_match (app_id, &flow, &ip_ue_2001_db8_11__3),
    "rule mismatch (IPAPP): [2001:db8:11::3]:12345 -> [2001:db8:12::3]:80");
  UPF_TEST (
    upf_app_ip_rule_match (app_id_any, &flow, &ip_ue_2001_db8_11__3),
...
tbcd_test ()
{
  ...
  u8 *actual =
    format (0, "%U", format_tbcd, sample_value, sizeof (sample_value));
...
static clib_error_t *
test_upf_command_fn (vlib_main_t *vm, unformat_input_t *input,
