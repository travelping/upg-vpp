...
typedef enum
{
  ...
  UPF_PFCP_RECEIVED_CORRUPTED = 9,
  // PFCP messages received
  // _ERROR counter should always follow _OK counter
  UPF_PFCP_HB_REQUEST_OK = 10,
  UPF_PFCP_HB_REQUEST_ERROR = 11,
  UPF_PFCP_HB_RESPONSE_OK = 12,
  UPF_PFCP_HB_RESPONSE_ERROR = 13,
  UPF_PFCP_PFD_MANAGEMENT_REQUEST_OK = 14,
  UPF_PFCP_PFD_MANAGEMENT_REQUEST_ERROR = 15,
  UPF_PFCP_PFD_MANAGEMENT_RESPONSE_OK = 16,
  UPF_PFCP_PFD_MANAGEMENT_RESPONSE_ERROR = 17,
  UPF_PFCP_ASSOCIATION_SETUP_REQUEST_OK = 18,
  UPF_PFCP_ASSOCIATION_SETUP_REQUEST_ERROR = 19,
  UPF_PFCP_ASSOCIATION_SETUP_RESPONSE_OK = 20,
  UPF_PFCP_ASSOCIATION_SETUP_RESPONSE_ERROR = 21,
  UPF_PFCP_ASSOCIATION_UPDATE_REQUEST_OK = 22,
  UPF_PFCP_ASSOCIATION_UPDATE_REQUEST_ERROR = 23,
  UPF_PFCP_ASSOCIATION_UPDATE_RESPONSE_OK = 24,
  UPF_PFCP_ASSOCIATION_UPDATE_RESPONSE_ERROR = 25,
  UPF_PFCP_ASSOCIATION_RELEASE_REQUEST_OK = 26,
  UPF_PFCP_ASSOCIATION_RELEASE_REQUEST_ERROR = 27,
  UPF_PFCP_ASSOCIATION_RELEASE_RESPONSE_OK = 28,
  UPF_PFCP_ASSOCIATION_RELEASE_RESPONSE_ERROR = 29,
  UPF_PFCP_NODE_REPORT_REQUEST_OK = 30,
  UPF_PFCP_NODE_REPORT_REQUEST_ERROR = 31,
  UPF_PFCP_NODE_REPORT_RESPONSE_OK = 32,
  UPF_PFCP_NODE_REPORT_RESPONSE_ERROR = 33,
  UPF_PFCP_SESSION_SET_DELETION_REQUEST_OK = 34,
  UPF_PFCP_SESSION_SET_DELETION_REQUEST_ERROR = 35,
  UPF_PFCP_SESSION_SET_DELETION_RESPONSE_OK = 36,
  UPF_PFCP_SESSION_SET_DELETION_RESPONSE_ERROR = 37,
  UPF_PFCP_SESSION_ESTABLISHMENT_REQUEST_OK = 38,
  UPF_PFCP_SESSION_ESTABLISHMENT_REQUEST_ERROR = 39,
  UPF_PFCP_SESSION_ESTABLISHMENT_RESPONSE_OK = 40,
  UPF_PFCP_SESSION_ESTABLISHMENT_RESPONSE_ERROR = 41,
  UPF_PFCP_SESSION_MODIFICATION_REQUEST_OK = 42,
  UPF_PFCP_SESSION_MODIFICATION_REQUEST_ERROR = 43,
  UPF_PFCP_SESSION_MODIFICATION_RESPONSE_OK = 44,
  UPF_PFCP_SESSION_MODIFICATION_RESPONSE_ERROR = 45,
  UPF_PFCP_SESSION_DELETION_REQUEST_OK = 46,
  UPF_PFCP_SESSION_DELETION_REQUEST_ERROR = 47,
  UPF_PFCP_SESSION_DELETION_RESPONSE_OK = 48,
  UPF_PFCP_SESSION_DELETION_RESPONSE_ERROR = 49,
  UPF_PFCP_SESSION_REPORT_REQUEST_OK = 50,
  UPF_PFCP_SESSION_REPORT_REQUEST_ERROR = 51,
  UPF_PFCP_SESSION_REPORT_RESPONSE_OK = 52,
  UPF_PFCP_SESSION_REPORT_RESPONSE_ERROR = 53,
  UPF_SESSION_REPORTS_GENERATED = 54,
