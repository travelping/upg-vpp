...
#ifndef __included_upf_tw_timer_1t_3w_1024sl_ov_h__
#define __included_upf_tw_timer_1t_3w_1024sl_ov_h__
...
#define TW_TIMERS_PER_OBJECT 256
#define LOG2_TW_TIMERS_PER_OBJECT 8
#define TW_SUFFIX _upf_1t_3w_1024sl_ov
#define TW_OVERFLOW_VECTOR 1
#define TW_FAST_WHEEL_BITMAP 1
#define TW_TIMER_ALLOW_DUPLICATE_STOP 1

#include <upf/upf_tw_timer_template.h>

#endif /* __included_upf_tw_timer_1t_3w_1024sl_ov_h__ */
