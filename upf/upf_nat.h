...
#include <upf/upf_nat_lib.h>
#include <upf/upf_nat_lib_inlines.h>
...
void nat_ed_del_sessions_per_binding (snat_main_per_thread_data_t *tsm,
                                      snat_binding_t *bn);

u16 nat_ed_add_binding (snat_main_per_thread_data_t *tsm,
                        ip4_address_t user_addr, ip4_address_t ext_addr,
